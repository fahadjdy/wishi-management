...
const actionColor = {
    on_time_payment: 'text-emerald-600',
    early_payment: 'text-emerald-600',
    late_payment: 'text-amber-600',
    missed_payment: 'text-red-600',
    manual_adjust: 'text-gray-600',
};
</script>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            <div class="surface-padded md:col-span-2">
                ...
                <dl class="text-sm space-y-2.5">
                    ...
                    <div class="flex justify-between"><dt class="text-gray-500">Max active WISHIs</dt><dd class="font-medium">{{ auth.user?.max_active_wishis || 'No limit' }}</dd></div>
                </dl>
            </div>
        </div>
            ...
            <ul v-else class="divide-y divide-gray-100">
                <li v-for="log in credit.logs" :key="log.id" class="py-3 flex items-center justify-between">
                    ...
                    <div class="text-right">
                        <div class="font-bold" :class="log.points > 0 ? 'text-emerald-600' : 'text-red-600'">
